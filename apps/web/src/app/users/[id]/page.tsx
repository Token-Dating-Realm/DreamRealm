...
const SAMPLE_USERS: Record<string, { name: string; bio: string; mode: string; verified: boolean; trustScore: number; joinedRealms: string[] }> = {
  "nova-star": {
    name: "NovaStar",
    bio: "Ambient music producer and midnight streamer. I believe sound is the purest form of connection.",
    mode: "creator_influencer",
    verified: true,
    trustScore: 94,
  ...
  "deep-thinker": {
    name: "DeepThinker",
    bio: "Philosophy grad student by day, existentialist by night. Looking for minds that wander.",
    mode: "friends_only",
    verified: false,
    trustScore: 78,
    joinedRealms: ["The Temple of Thoughts"],
  },
  "cupid-vibes": {
    name: "CupidVibes",
    bio: "Yoga teacher, vinyl collector, hopeless romantic. Here for genuine connection, not games.",
    mode: "single_female",
    verified: true,
    trustScore: 88,
...
export default function UserProfilePage({ params }: { params: { id: string } }) {
  const user = SAMPLE_USERS[params.id];
    ...
    <AppShell>
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-6 overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/10 to-accent/10 p-8">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="mb-2 text-sm text-primary capitalize">{user.mode.replace(/_/g, " ")}</p>
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-border bg-surface p-4 text-center">
            <p className="text-xl font-bold text-text">0</p>
